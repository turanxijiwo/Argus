...
API and MCP surface:
- `argus_server/server.py` registers 160 FastMCP tools and 8 MCP resources.
...
- AI/search: `AI_API_KEY`, `AI_MODEL`, `AI_API_BASE`, `AI_TEMPERATURE`, `AI_MAX_TOKENS`, `AI_TIMEOUT`, `TAVILY_API_KEY`, `EXA_API_KEY`, `PERPLEXITY_API_KEY`, `BRAVE_API_KEY`.
