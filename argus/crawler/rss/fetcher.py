...
from argus.storage.base import RSSItem, RSSData
from argus.utils.time import get_configured_time, is_within_days, DEFAULT_TIMEZONE
...
class RSSFetcher:
    ...
    def _create_session(self) -> requests.Session:
        ...
        session.headers.update({
            "User-Agent": "Argus/2.0 RSS Reader (https://github.com/argus)",
