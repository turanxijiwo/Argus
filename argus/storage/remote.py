...
from argus.storage.base import StorageBackend, NewsData, RSSItem, RSSData
from argus.storage.sqlite_mixin import SQLiteStorageMixin
from argus.utils.time import (
    DEFAULT_TIMEZONE,
    get_configured_time,
    format_date_folder,
...
class RemoteStorageBackend(SQLiteStorageMixin, StorageBackend):
    ...
    def __init__(
        ...
        # 创建临时目录
        self.temp_dir = Path(temp_dir) if temp_dir else Path(tempfile.mkdtemp(prefix="argus_"))
