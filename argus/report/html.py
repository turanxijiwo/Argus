...
from argus.report.helpers import html_escape
from argus.utils.time import convert_time_for_display
from argus.ai.formatter import render_ai_analysis_html_rich
...
def render_html_content(
    ...
    *,
    ...
    <body>
        ...
        <div class="container">
            <div class="header">
                <div class="header-watermark">Argus</div>
    ...
    html += """
            ...
            <div class="footer">
                <div class="footer-content">
                    由 <span class="project-name">Argus</span> 生成 ·
                    <a href="https://github.com/sansan0/Argus" target="_blank" class="footer-link">
                        GitHub 开源项目
                    </a>"""
    ...
    html += """
        ...
        <script>
            ...
            function toggleWideMode() {
                ...
                try { localStorage.setItem('argus-wide-mode', isWide ? '1' : '0'); } catch(e) {}
            ...
            function toggleDarkMode() {
                ...
                try { localStorage.setItem('argus-dark-mode', isDark ? '1' : '0'); } catch(e) {}
            ...
            async function saveAsImage() {
                ...
                try {
                    ...
                    const now = new Date();
                    const filename = `Argus_热点新闻分析_${now.getFullYear()}${String(now.getMonth() + 1).padStart(2, '0')}${String(now.getDate()).padStart(2, '0')}_${String(now.getHours()).padStart(2, '0')}${String(now.getMinutes()).padStart(2, '0')}.png`;
            ...
            async function saveAsMultipleImages() {
                ...
                try {
                    ...
                    // 下载所有图片
                    const now = new Date();
                    const baseFilename = `Argus_热点新闻分析_${now.getFullYear()}${String(now.getMonth() + 1).padStart(2, '0')}${String(now.getDate()).padStart(2, '0')}_${String(now.getHours()).padStart(2, '0')}${String(now.getMinutes()).padStart(2, '0')}`;
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // 自动检测宽屏模式
                var savedMode = null;
                try { savedMode = localStorage.getItem('argus-wide-mode'); } catch(e) {}
                ...
                // 暗色模式恢复
                var savedDark = null;
                try { savedDark = localStorage.getItem('argus-dark-mode'); } catch(e) {}
                if (savedDark === '1') {
