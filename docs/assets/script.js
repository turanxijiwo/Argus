...
// LocalStorage 键名
const STORAGE_KEY_CONFIG = 'argus_config_yaml';
const STORAGE_KEY_FREQUENCY = 'argus_frequency_txt';
const STORAGE_KEY_TIMELINE = 'argus_timeline_yaml';
const STORAGE_KEY_CONFIG_TIME = 'argus_config_time';
const STORAGE_KEY_FREQUENCY_TIME = 'argus_frequency_time';
const STORAGE_KEY_TIMELINE_TIME = 'argus_timeline_time';

// 官网配置文件 URL
const REMOTE_CONFIG_URL = 'https://raw.githubusercontent.com/sansan0/Argus/refs/heads/master/config/config.yaml';
const REMOTE_FREQUENCY_URL = 'https://raw.githubusercontent.com/sansan0/Argus/refs/heads/master/config/frequency_words.txt';
const REMOTE_TIMELINE_URL = 'https://raw.githubusercontent.com/sansan0/Argus/refs/heads/master/config/timeline.yaml';
const REMOTE_VERSION_URL = 'https://raw.githubusercontent.com/sansan0/Argus/refs/heads/master/version_configs';
    ...
    modal.innerHTML = `
        <div class="modal-content" style="max-width: 420px;">
            ...
            <div class="text-xs text-gray-400 mt-3 p-2 bg-gray-50 rounded">
                ...
                数据来源：<a href="https://github.com/sansan0/Argus" target="_blank" class="text-blue-500 hover:underline">sansan0/Argus</a>
            </div>
    ...
    switch(mod.key) {
        case "platforms":
            ...
            html += `<div class="flex items-center gap-2 mt-3">
                        ...
                        <a href="https://github.com/sansan0/Argus?tab=readme-ov-file#%E9%85%8D%E7%BD%AE%E8%AF%A6%E8%A7%A3" target="_blank" class="text-xs bg-gray-100 text-gray-600 px-3 py-1.5 rounded hover:bg-gray-200 transition-colors border border-gray-200 flex items-center gap-1 no-underline">
